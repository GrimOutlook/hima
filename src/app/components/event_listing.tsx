...
const EventListing: React.FC<EventListingProps> = ({className}) => {
    return (
        <div className="flex flex-row bg-red-400 m-2 rounded-lg h-18 transition duration-150 ease-in-out hover:-translate-y-1 hover:scale-102 hover:drop-shadow-lg cursor-pointer">
            {/* <!-- Hours --> */}
