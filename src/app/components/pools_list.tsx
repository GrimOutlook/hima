...
const PoolList: React.FC<PoolListProps> = ({className}) => {
    ...
    return (
        ...
        <div className={`${className} flex flex-col rounded-lg shadow-xs min-h-0 bg-linear-to-tr from-sky-300 to-red-400`}>
            <div className={`flex flex-col bg-zinc-100 rounded-lg m-2 grow min-h-0`}>
                {/* <!-- Pool list top bar --> */}
