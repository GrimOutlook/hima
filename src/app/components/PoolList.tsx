  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-3 w-full h-18">
        ...
        {/* <!-- Add event button --> */}
        <svg
          className="h-12 w-12 self-center justify-self-end m-4 fill-zinc-500 hover:fill-zinc-900 hover:drop-shadow-lg transition duration-150 ease-in-out hover:-translate-y-1 hover:scale-110 cursor-pointer"
          viewBox="0 0 24 24"
          onClick={() => dispatch(openPoolDialog())}
        >
          <path
            fillRule="evenodd"
