    ...
    >
      <div className="bg-zinc-100 flex flex-col grow rounded-lg m-2 min-h-0">
        ...
        <div className="grid grid-cols-3 w-full h-18">
          ...
          <div></div>
          {/* <!-- Event list title --> */}
          <div className="text-4xl text-center self-center justify-self-center m-2 dark:text-zinc-200">
            Events
          </div>
          {/* <!-- Add event button --> */}
          <svg
            className="h-12 w-auto self-center justify-self-end m-4 fill-zinc-500 hover:fill-zinc-900 hover:drop-shadow-lg transition duration-150 ease-in-out hover:-translate-y-1 hover:scale-110 cursor-pointer"
            viewBox="0 0 24 24"
